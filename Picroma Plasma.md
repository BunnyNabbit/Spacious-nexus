...
draft: true
---
*Picroma Plasma* is a vector-based graphics editor. By the looks of it, it wasn’t ever sold.[^1]
...
I think that Blender could be used to replicate its workflows. Though, I’m not much of a *Blender* nerd to figure all that out.

SVG has mesh gradients. I’m not too sure how compatible *Plasma* graphics would be with SVG as there is no converter to it. However, *Plasma* can export to PDF, which seems to retain most of the vector-based graphics.
