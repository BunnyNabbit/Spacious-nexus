...
I use *[[SilverBullet]]* for editing. It provides a web-based editor for my notes. And to generate the site, I use *[[Quartz]]*. *Spacious nexus* is also available as a [git repository on GitHub](https://github.com/BunnyNabbit/Spacious-nexus).
