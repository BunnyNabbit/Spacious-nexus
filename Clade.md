...
draft: true
---
*[Clade](https://tibleiz.net/clade/)* is a code editor. By default, its layout is inspired by *Smalltalk* system browsers.
...
- [[Elastic tabstops]] for solving vertical alignment on any font, including [[Proportional fonts|proportional fonts]].
- [[Explicit folding]] for collapsing code in a file and to provide [[Structure|structure]] in its layouts.

~~Overall, its set of features is small. But maybe its simplicity is a good thing?~~ As of recently, scripts were reintroduced.
