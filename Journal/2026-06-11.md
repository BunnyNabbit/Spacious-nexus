...
- Finally realized the point of *[standard.site](https://standard.site/)*. I’m now publishing *standard.site* documents. These link back the *Quartz* generated website.
  ...
  - It took me a long while to understand this. While `site.standard.document` records can store an editable copy of its documents. This isn’t required and its `content` field does not have a concrete standard. It’s intended for editor/viewing platforms like [*Leaflet*](http://leaflet.pub/).
