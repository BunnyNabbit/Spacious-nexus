...
## [Title Casing](https://en.wikipedia.org/wiki/Title_case)
...
To explore this idea, I developed the [*space Camel*](https://github.com/BunnyNabbit/space-camel) extension for *[[Visual Studio Code]]*. This simply adds a space to each uppercase letter that has a lowercase letter before it. “API” would be rendered as “A P I.”. Which I think isn’t a bug if the point is to write consistent names. 
